...
(
	...
	[PhotoId] [int] NULL,
	[UserId] [int] NULL,
 CONSTRAINT [Comments_PK__Comments__000000000000000C] PRIMARY KEY CLUSTERED ([Id] ASC) 
...
(
 ...
 CONSTRAINT [Galleries_PK__Galleries__0000000000000040] PRIMARY KEY CLUSTERED (	[Id] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
(
 ...
 CONSTRAINT [Photos_PK__Photos__0000000000000028] PRIMARY KEY CLUSTERED ([Id] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[Photos_Tags](
 ...
 CONSTRAINT [Photos_Tags_PK__Photos_Tags__000000000000004A] PRIMARY KEY CLUSTERED ([Photos_Id] ASC,	[Tags_TagName] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[Tags](
 ...
 CONSTRAINT [Tags_PK__Tags__0000000000000052] PRIMARY KEY CLUSTERED ([TagName] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[UserProfiles](
 ...
 CONSTRAINT [UserProfiles_PK__UserProfiles__0000000000000036] PRIMARY KEY CLUSTERED ([UserId] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[webpages_Membership](
 ...
 CONSTRAINT [webpages_Membership_PK__webpages_Membership__000000000000009A] PRIMARY KEY CLUSTERED (	[UserId] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[webpages_OAuthMembership](
	...
	[UserId] [int] NOT NULL,
 CONSTRAINT [webpages_OAuthMembership_PK__webpages_OAuthMembership__0000000000000078] PRIMARY KEY CLUSTERED ([Provider] ASC,[ProviderUserId] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[webpages_Roles](
 ...
 CONSTRAINT [webpages_Roles_PK__webpages_Roles__00000000000000A4] PRIMARY KEY CLUSTERED ([RoleId] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON),
 CONSTRAINT [webpages_Roles_UQ__webpages_Roles__00000000000000A9] UNIQUE NONCLUSTERED (	[RoleName] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
CREATE TABLE [dbo].[webpages_UsersInRoles](
	[UserId] [int] NOT NULL,
	[RoleId] [int] NOT NULL,
 CONSTRAINT [webpages_UsersInRoles_PK__webpages_UsersInRoles__00000000000000B3] PRIMARY KEY CLUSTERED ([UserId] ASC, [RoleId] ASC)
 	WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
GO
...
ALTER TABLE [dbo].[webpages_Membership] WITH CHECK ADD CONSTRAINT [DF_webpages_Membership_IsConfirmed]  DEFAULT ((0)) FOR [IsConfirmed]
GO

ALTER TABLE [dbo].[webpages_Membership] WITH CHECK ADD CONSTRAINT [DF_webpages_Membership_PasswordFailuresSinceLastSuccess]  DEFAULT ((0)) FOR [PasswordFailuresSinceLastSuccess]
GO